...
"resource": {
  ...
  "macros":[{
      ...
      "function":"__jsm",
      "vtp_javascript":["template","(function(d){d=\"logoMaker\\x3d\";var a=decodeURIComponent(document.cookie);a=a.split(\";\");for(var c=0;c\u003Ca.length;c++){for(var b=a[c];\" \"==b.charAt(0);)b=b.substring(1);if(0==b.indexOf(d))return\"LogoMaker\"}return\"BasicEditor\"})();"]
    },{
      "function":"__v",
      "vtp_dataLayerVersion":2,
  ...
  "rules":[
    [["if",0,1],["add",0]],
    [["if",1],["add",1,8,14,16,17,19,20,21,22]],
    [["if",2,3,4],["add",2]],
    [["if",1,5],["add",3,10,24,18]],
    [["if",1,6],["add",4]],
    [["if",3,7,8],["add",5]],
    [["if",3,9,10,11],["add",6]],
    [["if",3,12,13,14],["add",7]],
...
return null},yd=!1;if(H.querySelectorAll)try{var zd=H.querySelectorAll(":root");zd&&1==zd.length&&zd[0]==H.documentElement&&(yd=!0)}catch(a){}var sd=yd;var Nd={},K=null,Od=Math.random();Nd.C="GTM-52TNT8S";Nd.Ub="8j2";Nd.Nh="";var Pd={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},Qd="www.googletagmanager.com/gtm.js";
var Rd=Qd,Sd=null,Td=null,Ud="//www.googletagmanager.com/a?id="+Nd.C+"&cv=13",Vd={},Wd={},Xd=function(){var a=K.sequence||1;K.sequence=a+1;return a};
...
Z.a.tl=["google"],function(){function a(b){return function(){if(b.jd&&b.md>=b.jd)b.ed&&W("self").clearInterval(b.ed);else{b.md++;var c=Fl().getTime();Kl({event:b.O,"gtm.timerId":b.ed,"gtm.timerEventNumber":b.md,"gtm.timerInterval":b.interval,"gtm.timerLimit":b.jd,"gtm.timerStartTime":b.Re,"gtm.timerCurrentTime":c,"gtm.timerElapsedTime":c-b.Re,"gtm.triggers":b.Hh})}}}(function(b){Z.__tl=b;Z.__tl.b="tl";Z.__tl.g=!0;Z.__tl.priorityOverride=0})(function(b){I(b.vtp_gtmOnSuccess);if(!isNaN(b.vtp_interval)){var c=
{O:b.vtp_eventName,md:0,interval:Number(b.vtp_interval),jd:isNaN(b.vtp_limit)?0:Number(b.vtp_limit),Hh:String(b.vtp_uniqueTriggerId||"0"),Re:Fl().getTime()};c.ed=W("self").setInterval(a(c),0>Number(b.vtp_interval)?0:Number(b.vtp_interval))}})}();
